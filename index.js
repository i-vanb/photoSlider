...
// Отличная работа, всё соответствует поставленному в задаче условию :) единственное замечание есть к миниатюрам, в сочетании с переключением стрелками они работают не совсем корректно. Постарайтесь поправить следующее:
// Когда пользователь листает слайдер стрелками, активная миниатюра выделена, но все они в контейнер не вмещаются (на моем экране их влезает 7), и после переключения на 8 фотографию ни одна миниатюра не выделена, т.е. непонятно, где среди фотографий пользователь сейчас находится. Хорошо бы было добавить автоматическое перелистывание списка миниатюр при переключении стрелками